...
const StationSearch = (props: {
  ...
  useEffect(() => {
    if (props.searchBarOpen && inputRef.current) {
  ...
  return (
    ...
    >
      <input
        ref={inputRef}
        className="relative w-full px-4 py-2 text-lg border-2 border-gray-300 rounded-lg transition-all duration-300 ease-in-out"
        type="text"
