...
# This script scans all files in a Next.js project directory and outputs their content into a single file, excluding certain file types.
...
ignore_files=("*.ico" "*.png" "*.jpg" "*.jpeg" "*.gif" "*.svg" "*.css" "*.sh" "*.json")
...
# Start the recursive function from the project directory
